...
public class Testlesson1 {
    ...
    public void testRuleOneFactWithFact() {
        ...
        //project
        Applicant app1 = new Applicant(new CustomerId("ME001", "MEID"), "Joe Bloggs", "3130");
        sessionStatefull.insert(app1);

        Applicant app2 = new Applicant(new CustomerId("ME002", "MEID"), "Simon", "3131");
        sessionStatefull.insert(app2);
